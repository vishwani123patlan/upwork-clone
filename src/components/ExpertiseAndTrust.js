  ...
  return (
    <Box>
      ...
      <Stack sx={{display: 'flex', flexDirection: {xs: 'column-reverse', sm: 'column-reverse', md: 'row'}, marginTop: {xs: 4, sm: 6, md: 8}, borderRadius: 20}}>
        ...
        <img className='side-image' src="https://res.cloudinary.com/upwork-cloud-acquisition-prod/image/upload/f_auto,q_auto/brontes/for-enterprise/enterprise-2023.jpg" alt='side-slide' />
      </Stack>
